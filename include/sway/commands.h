...
sway_cmd cmd_panel;
sway_cmd cmd_panel_command;
sway_cmd cmd_restart;
sway_cmd cmd_showdesktop;
sway_cmd cmd_snap;
sway_cmd cmd_theme;
sway_cmd cmd_wallpaper;
...
sway_cmd cmd_window_gravity;
sway_cmd cmd_window_gravity_bounce;
sway_cmd cmd_window_gravity_drag;
sway_cmd cmd_double_click_time;
sway_cmd cmd_always_on_top;
sway_cmd cmd_alttab_style;
sway_cmd cmd_pointer_locate;
sway_cmd cmd_pointer_shake;
sway_cmd cmd_pointer_shake_max;
sway_cmd cmd_pointer_shake_rate;
sway_cmd cmd_pointer_shake_shakes;
