...
static void build_window(struct settings *s) {
	...
	static const struct {
		...
		{ "screensaver", "Screen saver", "screensaver bubbles mystify ribbons 3d text photos "
			"slideshow starfield pipes maze flying windows aurora word clock tiling diggers miners hellfire fire burn matrix microslop copilot ad commercial idle lock "
